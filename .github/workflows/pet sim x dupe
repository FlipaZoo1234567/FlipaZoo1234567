...
end if lib.Network.Invoke("Invite To Bank", mybanks[1]['BUID'],  690745327) then lib.Message.New("Dupe successfully! please rejoin"); else lib.Message.New("Dupe failure frowning please try again"); end;
